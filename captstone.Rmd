...
summary(hcaphs_df_measures)
zdistri_vars <- c("Provider.ID","HCAHPS.Measure.ID","HCAHPS.Linear.Mean.Value","Number.of.Completed.Surveys","Survey.Response.Rate.Percent.Footnote","Number.of.Completed.Surveys.Footnote")
...
```
Eliminating the rows that have been invalid scores, too few cases to report, Results are unavailable

```{r}
 hcaphs_df_measures_distri[!is.na(hcaphs_df_measures_distri$Survey.Response.Rate.Percent.Footnote),]
```
